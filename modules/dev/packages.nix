    ...
    nixos.packages =
      ...
      }:
      {
        ...
        config =
          lib.mkIf
            (
              config.modules.packages.basic
              || config.modules.packages.security
              || config.modules.packages.devTools
              || config.modules.packages.desktop
            )
            {
              environment.systemPackages =
                ...
                ++ (lib.optionals config.modules.packages.desktop (desktopPkgs {
                  inherit pkgs;
                }));
            };
      };
