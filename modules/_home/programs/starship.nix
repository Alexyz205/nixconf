...
}:
{
  programs.starship = {
    ...
    settings = {
      ...
      # Prompt layout
      format = "[](surface0)$os$username$sudo[](bg:color_peach fg:surface0)$directory[](fg:color_peach bg:color_green)$git_branch$git_status[](fg:color_green bg:color_sapphire)$c$rust$golang$nodejs$python$package[](fg:color_sapphire bg:color_blue)$docker_context$kubernetes$env_var$container$terraform$helm[](fg:color_blue bg:color_pink)$shell[ ](fg:color_pink)$line_break$character";
